...
from tortoise.contrib.gis.gis_functions import GeomFromText, AsWKT, AsText
...
class GeometryField(Field):
    ...
    def to_python_value(self, value: Union[str, BaseGeometry]) -> Optional[BaseGeometry]:
    ...
    def to_db_value(self, value: Union[str, BaseGeometry], instance) -> Optional[Function]:
    ...
    def get_select(self, capabilities, table):
        ...
        try:
            return selects[capabilities.dialect](
                super().get_select(capabilities, table)
            ).as_(self.model_field_name)
        except KeyError:
